...
public class KafakaSender {
    ...
    private final ReplyingKafkaTemplate<String, String, String> replyingStoreDtoTemplate;
    private final ReplyingKafkaTemplate<String, String, String> replyingIdTemplate;
    ...
    private Map<String, ReplyingKafkaTemplate<String, String, String>> replyingKafkaTemplateMap;

    @PostConstruct
    private void setUpMap() {
        this.replyingKafkaTemplateMap = Map.of("storesongdto", replyingIdTemplate, "getextractsong", replyingStoreDtoTemplate);
    }
    ...
    public String sendCommonMessageWithStringCallback(String topic, String objectString) throws ExecutionException, InterruptedException, TimeoutException, JsonProcessingException {
        ...
        RequestReplyFuture<String, String, String> future = replyingKafkaTemplateMap.get(topic).sendAndReceive(record);
    ...
    public String getMeta(Integer id) throws ExecutionException, InterruptedException, TimeoutException {
        RequestReplyFuture<String, Integer, String> getmeta = replyingTemplate.sendAndReceive(new ProducerRecord<String, Integer>("getmeta", id));
        return getmeta.get(10000, TimeUnit.MILLISECONDS).value();
    }
